...
<div class="main">
    <div class="topbar">
        ...
        <div style="display:flex;align-items:center;gap:16px;">
            ...
            <a href="<?= BASE_URL ?>/admin/logout" style="background:rgba(224,85,85,.12);color:#F08080;border:1px solid rgba(224,85,85,.25);padding:7px 14px;border-radius:5px;font-size:.8rem;letter-spacing:.06em;text-transform:uppercase;text-decoration:none;transition:all .2s;" onmouseover="this.style.background='rgba(224,85,85,.22)'" onmouseout="this.style.background='rgba(224,85,85,.12)'">← Logout</a>
        </div>
    </div>
    <div class="content">
        <div class="cards">
